...
% Requires PGF >= v 1.18.
% %return statements assist in generation of the test files (regex-able delimiter)
...
%    > Standardise heights and widths (switch from use of scale)
...
% Di-deoxyhexose
\newcommand{\Dideoxyhexose}{\raisebox{0pt}{\tikz{\node[draw, line width=0.3mm, scale=1.1, minimum height=0.2cm, minimum width=0.6cm, rectangle, fill=white](){};}}}
\newcommand{\Oli}{\raisebox{0pt}{\tikz{\node[draw, line width=0.3mm, scale=1.1, minimum height=0.2cm, minimum width=0.6cm, rectangle, fill=Blue](){};}}}
\newcommand{\Tyv}{\raisebox{0pt}{\tikz{\node[draw, line width=0.3mm, scale=1.1, minimum height=0.2cm, minimum width=0.6cm, rectangle, fill=Green](){};}}}
\newcommand{\Abe}{\raisebox{0pt}{\tikz{\node[draw, line width=0.3mm, scale=1.1, minimum height=0.2cm, minimum width=0.6cm, rectangle, fill=Orange](){};}}}
\newcommand{\Par}{\raisebox{0pt}{\tikz{\node[draw, line width=0.3mm, scale=1.1, minimum height=0.2cm, minimum width=0.6cm, rectangle, fill=Pink](){};}}}
\newcommand{\Dig}{\raisebox{0pt}{\tikz{\node[draw, line width=0.3mm, scale=1.1, minimum height=0.2cm, minimum width=0.6cm, rectangle, fill=Purple](){};}}}
\newcommand{\Col}{\raisebox{0pt}{\tikz{\node[draw, line width=0.3mm, scale=1.1, minimum height=0.2cm, minimum width=0.6cm, rectangle, fill=LightBlue](){};}}}
%return
...
\newcommand{\Dideoxynonulosonate}{\raisebox{0pt}{\tikz{\node[draw, line width=0.3mm, scale=1.1, minimum height=0.15cm, minimum width=0.9cm, diamond, aspect=2, fill=white](){};}}}
\newcommand{\Pse}{\raisebox{0pt}{\tikz{\node[draw, line width=0.3mm, scale=1.1, minimum height=0.2cm, minimum width=0.9cm, diamond, aspect=2, fill=Green](){};}}}
\newcommand{\Leg}{\raisebox{0pt}{\tikz{\node[draw, line width=0.3mm, scale=1.1, minimum height=0.2cm, minimum width=0.9cm, diamond, aspect=2, fill=Yellow](){};}}}
\newcommand{\Aci}{\raisebox{0pt}{\tikz{\node[draw, line width=0.3mm, scale=1.1, minimum height=0.2cm, minimum width=0.9cm, diamond, aspect=2, fill=Pink](){};}}}
\newcommand{\eLeg}{\raisebox{0pt}{\tikz{\node[draw, line width=0.3mm, scale=1.1, minimum height=0.2cm, minimum width=0.9cm, diamond, aspect=2, fill=LightBlue](){};}}}
%return

% Unknown
\newcommand{\Unknown}{\raisebox{0pt}{\tikz{\node[draw, line width=0.3mm, scale=1.1, minimum height=0.1cm, minimum width=0.7cm, chamfered rectangle, fill=white](){};}}}
\newcommand{\Bac}{\raisebox{0pt}{\tikz{\node[draw, line width=0.3mm, scale=1.1, minimum height=0.1cm, minimum width=0.7cm, chamfered rectangle, fill=Blue](){};}}}
\newcommand{\LDmanHep}{\raisebox{0pt}{\tikz{\node[draw, line width=0.3mm, scale=1.1, minimum height=0.1cm, minimum width=0.7cm, chamfered rectangle, fill=Green](){};}}}
\newcommand{\Kdo}{\raisebox{0pt}{\tikz{\node[draw, line width=0.3mm, scale=1.1, minimum height=0.1cm, minimum width=0.7cm, chamfered rectangle, fill=Yellow](){};}}}
\newcommand{\Dha}{\raisebox{0pt}{\tikz{\node[draw, line width=0.3mm, scale=1.1, minimum height=0.1cm, minimum width=0.7cm, chamfered rectangle, fill=Orange](){};}}}
\newcommand{\DDmanHep}{\raisebox{0pt}{\tikz{\node[draw, line width=0.3mm, scale=1.1, minimum height=0.1cm, minimum width=0.7cm, chamfered rectangle, fill=Pink](){};}}}
\newcommand{\MurNAc}{\raisebox{0pt}{\tikz{\node[draw, line width=0.3mm, scale=1.1, minimum height=0.1cm, minimum width=0.7cm, chamfered rectangle, fill=Purple](){};}}}
\newcommand{\MurNGc}{\raisebox{0pt}{\tikz{\node[draw, line width=0.3mm, scale=1.1, minimum height=0.1cm, minimum width=0.7cm, chamfered rectangle, fill=LightBlue](){};}}}
\newcommand{\Mur}{\raisebox{0pt}{\tikz{\node[draw, line width=0.3mm, scale=1.1, minimum height=0.1cm, minimum width=0.7cm, chamfered rectangle, fill=DarkBrown](){};}}}
%\return
...
% Note Psic = Psi, but Psi is a reserved tex command.
